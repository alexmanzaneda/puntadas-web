...
export default function ImageGallery({ images, alt }: ImageGalleryProps) {
  ...
  return (
    <div>
      {/* Imagen principal */}
      <div className="flex items-center justify-center bg-stone-50 rounded-lg overflow-hidden aspect-square sm:h-96 sm:aspect-auto md:h-auto md:aspect-square relative group">
